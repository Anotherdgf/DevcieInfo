package com.anotherdgf.deviceinfo.view;
...
public class CustomDialog extends DialogFragment{
     ...
     * @return
     */
    public static CustomDialog showInstance(Activity activity, CharSequence message, CharSequence cancle, CancleCallback cancleCallback, CharSequence confirm, ConfirmCallback confirmCallback) {
     ...
     * @return
     */
    public static CustomDialog showInstance(Activity activity, CharSequence message, CharSequence cancle, CancleCallback cancleCallback, CharSequence confirm, ConfirmCallback confirmCallback, BackCallback backCallback) {
